...
class Applab_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Applab ] Social Links', 'applab-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'applab-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'applab-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'applab-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'applab-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'applab-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'applab-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'applab-companion'); ?></label>
...
} // Class applab_social_links ends here


// Register and load the widget
function applab_social_links_widget_load() {
	register_widget( 'Applab_social_links' );
}
add_action( 'widgets_init', 'applab_social_links_widget_load' );