...
----------------------------------------*/
class applab_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('applab_instagram_photo',esc_html__('[ Applab ] Intagram Photo','applab-companion'),array(
			'description' => esc_html__('Applab Instagram Photo Widget','applab-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'applab-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'applab-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'applab-companion'); ?></label>
...
if(!function_exists('applab_instagram_widgets')):
	function applab_instagram_widgets(){
		register_widget('applab_instagram_photo');
	}
	add_action('widgets_init','applab_instagram_widgets');
endif;
