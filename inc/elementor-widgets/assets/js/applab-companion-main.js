(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".applab-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".applab-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".applab-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.applab-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.applab-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $( '.applab-subscribe-newsletter-area' );
    if( $subscribe.length ){
